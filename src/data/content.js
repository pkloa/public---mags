...
export const contentData = {
  ...
  'collection': {
    ...
    text: [
      ...
      'source jul \'95/ biggie',
      'source jun \'96/ geto boys',
      'source oct \'96/ da brat',
      'source dec \'96/ snoop dogg',
      ...
      'murder dog vol 5 issue #2/ c murder',
      'murder dog vol 6 issue #4/ hot boys',
      ...
      'Respect Magazine⁷',
      '',
      'respect vol 2 issue #1/ waka flocka flame',
      'respect vol 2 issue #3/ tyler, the creator',
      'respect vol 3 issue #2/ birdman',
      'respect vol 3 issue #3/ drake',
      'respect vol 4 issue #1/ j cole',
      'respect vol 4 issue #2/ lil wayne',
      'respect vol 4 issue #3/ black hippy',
      '',
      'King Magazine¹',
      '',
      ...
      'Platinum Magazine¹',
      '',
      'platinum jun \'00/ master p',
      '',
      'Sneeze Magazine¹',
      '',
      'sneeze issue no. 68/ asap rocky',
      '',
      'Huck Magazine¹',
      '',
      'huck issue 83/ rza',
      ...
      '',
      'rolling stone feb \'99/ lauryn hill',
      ...
      'true jun \'96/ nas*',
      'true sep \'96/ laurence fishburne',
      'trace jun \'97/ goldie',
      'trace nov \'97/ method man',
      'trace sep \'98/ black girls rule!',
      'trace oct \'98/ dmx',
      'trace \'00/ ghostface killah',
      '',
      'Hip Hop Connection Magazine¹',
      '',
      'hhc nov \'93/ snoop dogg',
      '',
      'Blues & Soul Magazine¹',
      '',
      'blues & soul aug \'02/ nelly',
      '',
      'Dazed & Confused Magazine¹',
      '',
      'dazed jan \'01/ gorillaz',
      '',
      'NME Magazine²⁷',
      '',
...
public---mags means the world to me and i won’t be stopping anytime soon. i am forever grateful for all the love, thank you!

more scans to come, always!
